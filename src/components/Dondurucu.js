...
ADIM 1:
  State hookunu kullanara, bir 'döndürücüAçık', 'setdöndürücüAçik' çifti oluşturun.
...
/* ADIM 1 */
const [döndürücüAçık,setdöndürücüAçik] = useState(false);

  const toggleDondurucu = () => {
  /* ADIM 4 */
  setdöndürücüAçik (!döndürücüAçık);
  };
